...
<p style="font-size: 34px; line-height: 1.5; text-align: center; font-family: inherit; word-break: break-word; mso-line-height-alt: 51px; margin: 0;"><span style="font-size: 34px;"><strong><span style="font-size: 34px;"><span style="color: #2190e3; font-size: 34px;">{{$name}}</span></span></strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 18px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 22px; margin: 0;"><span style="font-size: 18px; color: #000000;">Thanks for Your Feedback. We’ll be sending an occasional email with everything new and good.</span></p>
</div>
<!--[if (IE)]></div><![endif]-->
</body>
</html>