                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
										{{$name}}, we greatly appreciate your suggestions and criticisms and we hope that we can give the best in the future
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;" width="75%">
                                        &reg; Giri,Goldy - 2020<br/>
                                        <a href="http://127.0.0.1:8000" style="color: #ffffff;"><font color="#ffffff">Check Out</font></a> to this newsletter instantly
                                    </td>
